...
break;
    ...
    case 'generateMenuItemsFromImages':
      ...
      $promptText = "You are a restaurant menu data extractor. Look at the attached menu photo(s) and/or PDF document carefully and extract every dish/item you can read.\n\n"
        ...
        . "3. ITEM NAME: Extract ONLY the dish/product name itself, exactly as printed — never fold in a column header or label word like \"Price\", \"Rate\", \"Cost\", \"Rs\", \"MRP\", or \"Amount\" that merely happens to sit near the price in the photo/PDF's layout. For example, if the menu shows a \"Price\" column header next to a row reading \"Momo ... 150\", the Item Name must be exactly \"Momo\" — never \"Price of Momo\" or \"Momo Price\".\n"
        . "4. PRICE: Numbers only (e.g. 199, 12.99), no currency symbols and no label words. If a price is unreadable, put 0.\n"
        . "5. TYPE: One of exactly: Veg, Non Veg, Egg, Drink, Dessert, Other.\n"
        . "6. DESCRIPTION: Write a short realistic 5-15 word description based on the item name and type.\n"
        . "7. PREPTIME: Estimate minutes based on item type (appetizers 5-10, mains 15-25, desserts 5-10, drinks 2-5).\n"
        . "8. CALORIES: Estimate a realistic number, or leave blank if unsure.\n"
        . "9. STOCK: Always 1.\n"
        . "10. VARIATIONS: If the photo shows sizes/options with different prices, use \"Small:99,Medium:149,Large:199\" format, otherwise leave blank.\n"
        . "11. IMAGEURL: Always leave this field blank — do not invent a URL.\n"
        . "12. Extract every item visible in the photo(s)/PDF, including any non-food products the menu lists (e.g. cigarettes, paan, packaged goods) — do not skip real rows. Do not invent items that are not present in the source.\n\n"
