...
define('PERMISSION_MANAGE_LOYALTY', 'manage_loyalty');
...
function getUserRole() {
    ...
    // Branch admin inherits admin role
...
function isLoggedIn() {
    ...
    return (isset($_SESSION['user_id']) || isset($_SESSION['staff_id']) || isset($_SESSION['branch_admin_id'])) &&
